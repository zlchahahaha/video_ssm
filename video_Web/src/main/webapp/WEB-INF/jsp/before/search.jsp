...
<header>
    <div class="container">
        ...
        <a onclick="pyRegisterCvt()" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=666666&site=qq&menu=yes"><img src="${pageContext.request.contextPath}/img/we.png" draggable="false">联系我们</a>
        <a class="color_e4"><img src="${pageContext.request.contextPath}/img/phone.png" draggable="false"> 0375-2089092&#x3000;&#x3000;4008-800-8800</a>

    </div>
</header>
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="好先生教育的logo" onclick="location.href='${pageContext.request.contextPath}/index.jsp'"
             draggable="false">
        <ul class="text_13 f_right">
            ...
            <li class="nav_down">
                ...
                <ul id="nav_down" class="t_center">
                    <c:forEach items="${subjectList}" var="subject">
                        <li>
                            <a target="_blank" href="${pageContext.request.contextPath}/course/course/${subject.id}">${subject.subjectName}</a>
                        </li>
                    </c:forEach>
                </ul>
            </li>
            ...
            <li><a href="${pageContext.request.contextPath}/goodSir/news" target="_blank">好先生新闻</a></li>
            <li class="nav_last">
...
<div id="app">
    <!--banner图-->
    <div class="banner"
         style="background-image: url(${pageContext.request.contextPath}/img/banner-2.jpg)"></div>

    <!--面包屑导航-->
    <div class="container mian-nav">Web课 / "${searchName}"的搜索结果</div>
        ...
        <div class="container">
            ...
            <div class="section">
                <div class="classifyName">
                    <p class="title title-first">查询结果</p>
                </div>
                <ul>
                    <!--节-->
                    <c:forEach items="${videoList}" var="video" varStatus="i">
                        <li class="section-main" onclick="getVideo(${video.id})">
                            <div class="thum" style="background-image: url('${video.imageUrl}')">
                                <!--http://vod.wanfang.com/gkk/h5/c1/image/course/01.jpg-->
                            </div>
                            <p>
